	...
	var t = function(e) {
			...
			n.onSkinLoadHandler = function(e) {
				...
				if (n.countLoadedSkinImages < n.totalGraphics) {
					n.loadImageId_to = setTimeout(n.loadSkin, 0)
				} else {
					n.dispatchEvent(t.SKIN_PROGRESS, {
						percent: n.countLoadedSkinImages / n.totalGraphics
					});
...
(window._gsQueue || (window._gsQueue = [])).push(function() {
	_gsDefine("TweenMax", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function(e, t, n) {
		...
		i.updateTo = function(e, t) {
			var r = this.ratio,
				i;
			if (t) if (this.timeline != null) if (this._startTime < this._timeline._time) {
		...
		i.render = function(e, t, n) {
			...
			if (o == 0) if (this.vars.onStart) if (this._totalTime !== 0 || this._duration === 0) if (!t) {
			...
			if (this._cycle != u) if (!t) if (!this._gc) if (this.vars.onRepeat) {
		...
		u.render = function(e, t, n) {
			...
			if (e >= r) {
				...
				if (!this._reversed) if (!this._hasPausedChild()) {
					l = true;
					h = "onComplete";
					if (this._duration === 0) if (e === 0 || this._rawPrevTime < 0) if (this._rawPrevTime !== e) {
						n = true
					}
				}
				this._rawPrevTime = e;
				...
				if (e < 0) {
					this._active = false;
					if (this._duration === 0) if (this._rawPrevTime >= 0) {
						n = true
					}
				} else if (!this._initted) {
					n = true
	...
	_gsDefine("TimelineMax", ["TimelineLite", "TweenLite", "easing.Ease"], function(e, t, n) {
		...
		u.render = function(e, t, n) {
			...
			if (e >= r) {
				...
				if (!this._locked) {
					...
					if (this._repeat !== 0) {
						...
						if (this._cycle !== 0) if (this._cycle === this._totalTime / g) {
							this._cycle--
						}
			...
			if (this._cycle !== c) if (!this._locked) {
			...
			if (o === 0) if (this.vars.onStart) if (this._totalTime !== 0) if (!t) {
			...
			if (m) if (!this._locked) if (!this._gc) if (u === this._startTime || a != this._timeScale) if (this._time === 0 || r >= this.totalDuration()) {
				if (p) {
					if (this._timeline.autoRemoveChildren) {
						this._enabled(false, false)
					}
		...
		var t = function(t, n) {
			...
			v = function(e, t, n, r) {
				...
				if (r) {
					...
					a = e.length;
					while (--a > -1) {
						if (typeof(v = e[a][t]) === "string") if (v.charAt(1) === "=") {
	...
	_gsDefine("plugins.CSSPlugin", ["plugins.TweenPlugin", "TweenLite"], function(e, t) {
		...
		var i = /[^\d\-\.]/g,
			...
			M = function(e, t, n, r) {
				var s = {},
					o, u;
				for (u in t) {
					if (u !== "cssText") if (u !== "length") if (isNaN(u)) if (e[u] != (o = t[u])) if (o !== B) if (typeof o === "number" || typeof o === "string") {
			...
			F = function(e, t, n) {
				...
				if (h.rotation < c) if (h.rotation > -c) if (u || a) {
					h.rotation = 0
				}
				if (h.skewX < c) if (h.skewX > -c) if (a || f) {
					h.skewX = 0
				}
				if (n) {
					e._gsTransform = h
		...
		r._parseVars = function(e, t, n, r) {
			...
			for (u in e) {
				...
				if (u === "opacity") if (e.autoAlpha != null) {
					if (l === "1") if (A(t, "visibility", n) === "hidden") {
						l = f.b = "0"
					}
		...
		r._parseTransform = function(e, t, n, r) {
			...
			if (typeof t === "object") {
				...
				if (u.skewY < o) if (u.skewY > -o) {
					u.skewY = 0
				}
				if (u.skewX < o) if (u.skewX > -o) {
					u.skewX = 0
				}
				if (u.rotation < o) if (u.rotation > -o) {
					u.rotation = 0
				}
			...
			for (f in _) {
				if (i[f] !== u[f] || g[f] != null) if (f !== "shortRotation") if (f !== "scale") {
					this._firstPT = l = {
						_next: this._firstPT,
						t: i,
						p: f,
		...
		r._parseBezier = function(e, t, n, r) {
			...
			if (e.autoRotate) if (!(e.autoRotate instanceof Array)) {
			...
			if (u._autoRotate = e.autoRotate) if (!E) {
			...
			if (this._transform) {
				...
				if (B && !t.rotation && !t.skewX) {
					...
					if (B) {
						...
						if (e === 0 || e === 1) if (p === 1) if (v === 0) if (m === 0) if (g === 1) if (!S || x.indexOf("Dx=0, Dy=0") !== -1) if (!u.test(b) || parseFloat(RegExp.$1) === 100) {
							this._style.removeAttribute("filter")
						}
					}
				}
...
(function(e) {
	...
	u.duration = function(e) {
		...
		this._uncache(true);
		if (this._timeline.smoothChildTiming) if (this._active) if (e != 0) {
	...
	var A = function(e, t, n) {
		...
		O = function(e, t, n, r, i) {
			...
			while (--s > -1) {
				...
				} else if (u._startTime <= f) if (u._startTime + u.totalDuration() / u._timeScale + 1e-10 > f) if (!((t._duration === 0 || !u._initted) && f - u._startTime <= 2e-10)) {
					l[c++] = u
				}
			}
			s = c;
	...
	u._init = function() {
		...
		if (this._overwrittenProps) if (this._firstPT == null) if (typeof this.target !== "function") {
			this._enabled(false, false)
		}
	...
	u._initProps = function(e, t, n, r) {
		...
		if (this._overwrite > 1) if (this._firstPT) if (n.length > 1) if (O(e, this, t, this._overwrite, n)) {
			this._kill(t, e);
			return this._initProps(e, t, n, r)
		}
		return o
	...
	u.render = function(e, t, n) {
		...
		if (r === 0) if (this.vars.onStart) if (this._time !== 0 || this._duration === 0) if (!t) {
...
(function(e) {
	var t = function(n) {
			...
			r.dataSkinProgressHandler = function(e) {
				r.preloader_do.update(e.percent, "åŠ è½½çš®è‚¤: " + Math.round(e.percent * 100) + "%")
			};
			...
			r.setupPreloader = function() {
				...
				r.preloader_do = new FWDPreloader(r, '', 40, 43, 60, r.data.preloaderFontColor_str, r.data.preloaderBackgroundColor_str);
